...
export function FriendlyFeudWordmark({ className, compact = false }: FriendlyFeudWordmarkProps) {
  return (
    <span
      className={cn(
        "inline-flex flex-col items-start font-black uppercase leading-[0.58]",
    ...
    >
      ...
      <span
        className={cn(
          "bg-[linear-gradient(135deg,#fef3c7_0%,#fbbf24_45%,#f59e0b_100%)] bg-clip-text text-transparent drop-shadow-[0_0_16px_rgba(251,191,36,0.24)]",
          compact ? "-mt-[0.34em]" : "-mt-[0.46em]",
        )}
      >
        Feud
      </span>
